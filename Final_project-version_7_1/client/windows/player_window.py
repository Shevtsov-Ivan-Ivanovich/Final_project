...
class PlayerWindow(QWidget):
    ...
    def update_character_stat(self, stat_name, value):
        ...
        # Для игрока обновление через API, а не через GM команду
